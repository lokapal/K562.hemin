...
./lib/mergebedgraphmean.sh intersect_reps.bedGraph K562.4C.white.nodfam.intersect.bedGraph
./lib/addSubseq.pl /usr/local/genomes/hg38.mfa intersect_merged.bed > K562.4C.white.nodfam.intersect.txt
sort -k1,1 -k2,2n -k3,3n K562.4C.white.nodfam.intersect.txt -o K562.4C.white.nodfam.intersect.txt
#
# Part 2. Assign genes to K562 4C-associated intersected replicates noDFAM mappings
cp K562.4C.white.nodfam.intersect.txt 4C.bed
...
./lib/tbl_addexpr.pl 4C.genetable ./lib/K562.white.mean.TPM
cat 4C.genetable.expr 4C.empty > K562.4C.white.intersect.all.txt
mv 4C.genetable.expr K562.4C.white.intersect.genes.txt
sort -k1,1V -k2,2n -k3,3n K562.4C.white.intersect.genes.txt -o K562.4C.white.intersect.genes.txt
sort -k1,1V -k2,2n -k3,3n K562.4C.white.intersect.all.txt -o K562.4C.white.intersect.all.txt
