...
#hg19 2864785220
#hg38 2913022398
# TYPE can be white or red
TYPE=white
bamCoverage --effectiveGenomeSize 2913022398 --normalizeUsing RPKM --ignoreForNormalization chr14 --exactScaling -p 30 -b ..\Align\$TYPE.rep1.bam -o rep1.bw
bamCoverage --effectiveGenomeSize 2913022398 --normalizeUsing RPKM --ignoreForNormalization chr14 --exactScaling -p 30 -b ..\Align\$TYPE.rep2.bam -o rep2.bw
