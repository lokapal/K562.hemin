...
# Output: 1. rnaseq.red.rep1.bam          K562 treated by hemin (red) RNASeq replicate 1 alignment to hg38
#            rnaseq.red.rep2.bam          K562 treated by hemin (red) RNASeq replicate 2 alignment to hg38
#         2. RED_Pearson.pdf              K562 treated by hemin (red) RNASeq replicates consistency check: Pearson correlation
#            RED_Spearman.pdf             K562 treated by hemin (red) RNASeq replicates consistency check: Spearman correlation
#
# Dependency tools:
...
mv rep1.Aligned.sortedByCoord.out.bam rnaseq.red.rep1.bam
samtools index -@ 16 rnaseq.red.rep1.bam
mv rep2.Aligned.sortedByCoord.out.bam rnaseq.red.rep2.bam
samtools index -@ 16 rnaseq.red.rep2.bam
# Quality Control to check consistency between replicates (optional)
bamCoverage --effectiveGenomeSize 2913022398 --normalizeUsing RPKM --exactScaling -p 30 -b rnaseq.red.rep1.bam -o rep1.bw
bamCoverage --effectiveGenomeSize 2913022398 --normalizeUsing RPKM --exactScaling -p 30 -b rnaseq.red.rep2.bam -o rep2.bw
multiBigwigSummary bins -p 30 -b rep1.bw rep2.bw -o res12hs.npz
plotCorrelation -in res12hs.npz -c spearman --removeOutliers --skipZeros -p scatterplot -o RED_spearman.pdf --labels RED.rep1 RED.rep2 --log1p
plotCorrelation -in res12hs.npz -c pearson  --removeOutliers --skipZeros -p scatterplot -o RED_pearson.pdf  --labels RED.rep1 RED.rep2 --log1p
